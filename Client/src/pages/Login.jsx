            ...
            {!isLogin && (
              <div>
                ...
                <input
                  ...
                  required={!isLogin}
                  className="w-full px-4 py-3 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-[#06A3DA] focus:border-transparent"
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  onChange={handleChange}
                  required
                  className="w-full pl-10 pr-4 py-3 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-[#06A3DA] focus:border-transparent"
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  onChange={handleChange}
                  required
                  className="w-full pl-10 pr-12 py-3 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-[#06A3DA] focus:border-transparent"
                  placeholder="••••••••"
                />
                <button
                  type="button"
          ...
          <div className="mt-6 text-center">
            <p className="text-[#6B6A75]">
              ...
              <button
                ...
                className="text-[#06A3DA] font-semibold hover:underline"
              >
